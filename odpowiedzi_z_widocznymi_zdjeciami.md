...
![Widok klienta – formularz zakupu](odpowiedzi_md_assets/01_widok_klienta.png)

2. **`web.php`**: routing kieruje żądanie do `ClientDashboardController::buyTicket`.

![Routing zakupu karnetu](odpowiedzi_md_assets/02_routing_web.png)

3. **Kontroler** sprawdza użytkownika i wywołuje `TicketPurchaseService::buy`.

![Kontroler buyTicket](odpowiedzi_md_assets/03_kontroler_buyTicket.png)

4. **Serwis** wykonuje zapis zakupu do bazy przez Eloquent.

![Serwis zakupu karnetu](odpowiedzi_md_assets/04_serwis_zakupu.png)
...
![Relacja ticketPurchases w User](odpowiedzi_md_assets/05_relacja_user.png)
